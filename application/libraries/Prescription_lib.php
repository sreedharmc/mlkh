...
class Prescription_lib
{
	...
	function add_item($item_id,$quantity=1,$price=null,$description=null,$serialnumber=null,$invoiced=null)
	{
		...
		array(
			...
			'dosage' => $this->CI->Prescribe_model->get_info_by_id($item_id)->dosage,
			'route_id' => $this->CI->Prescribe_model->get_info_by_id($item_id)->route_of_adm,
			'frequency_id' => $this->CI->Prescribe_model->get_info_by_id($item_id)->frequency,
			'duration' => $this->CI->Prescribe_model->get_info_by_id($item_id)->duration,
			//'quantity'=>$quantity,
           // 'discount'=>$discount,
