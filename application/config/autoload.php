...
$autoload['helper'] = array('form','url','table','text','currency', 'html', 'download','date');
...
$autoload['language'] = array('common', 'config', 'customers', 'employees', 'error', 'items', 'login', 
	'module', 'reports', 'sales','suppliers','receivings','giftcards', 'item_kits','profile','invoices',
	'waivers','admissions', 'prescribe', 'dispense','triage', 'prescription', 'dispensing');
