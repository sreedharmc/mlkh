...
<?php echo form_open("docprescribe/add",array('id'=>'add_item_form')); ?>
...
<th style="width:35%;"><?php echo $this->lang->line('presctiption_item_name'); ?></th>
...
else
{
	...
	?>
		...
		?>
			...
			<td><?php echo form_input(array('name'=>'dosage','value'=>$item['dosage'],'size'=>'3')); ?></td>

		
		<td>
		<?php echo form_dropdown('roa', $roa, $item['route_id']); ?></td>
		<td>
		<?php echo form_dropdown('frequency', $frequency, $item['frequency_id']); ?></td>

		<td><?php echo form_input(array('name'=>'duration','value'=>$item['duration'],'size'=>'3')); ?></td>
		<td><?php //echo form_submit("edit_item", $this->lang->line('invoices_edit_item'));?></td>
		<td><?php echo anchor("docprescribe/delete_item/$line",'['.$this->lang->line('common_delete').']');?></td>
		</tr>
